...
public class AudioEncoderAdapter {
    ...
    private MediaMuxerAdapter mediaMuxerRunnable;
    ...
    public AudioEncoderAdapter(MediaMuxerAdapter mediaMuxerAdapter) {
        this.mediaMuxerRunnable = mediaMuxerAdapter;
    ...
    //启动
    public void startRecordEncoder() {
        ...
        do {
            ...
            if (encoderStatus == MediaCodec.INFO_TRY_AGAIN_LATER) {
                ...
                if (mediaMuxerRunnable != null) {
                    ...
                    mediaMuxerRunnable.addTrackIndex(MediaMuxerAdapter.TRACK_AUDIO, format);
                }
                ...
                if (mBufferInfo.size != 0 && mediaMuxerRunnable != null && mediaMuxerRunnable.isMuxerStart()) {
                    mBufferInfo.presentationTimeUs = getPTSUs();
                    Log.e(TAG, "发送音频数据 " + mBufferInfo.size);
                    mediaMuxerRunnable.addMuxerData(new MediaMuxerAdapter.MuxerData(MediaMuxerAdapter.TRACK_AUDIO, encodedData, mBufferInfo));
