...
public class MediaMuxerAdapter {
    ...
    private static MediaMuxerAdapter mediaMuxerThread;

    private AudioEncoderAdapter audioThread;
    private RecordVideoAdapter videoThread;
    ...
    public void startMuxer() {
        if (mediaMuxerThread == null) {
            synchronized (MediaMuxerAdapter.class) {
                if (mediaMuxerThread == null) {
                    mediaMuxerThread = new MediaMuxerAdapter();
    ...
    public synchronized void addTrackIndex(int index, MediaFormat mediaFormat) {
        ...
        if (mediaMuxer != null) {
            ...
            try {
                ...
                e.printStackTrace();
                Log.e(TAG, "addTrack 异常:" + e.getMessage());
                return;
            }
    ...
    private void initMuxer() {
        ...
        audioThread = new AudioEncoderAdapter(this);
        videoThread = new RecordVideoAdapter(1920, 1080, surface,this);
        try {
            readyStart();
            //开启声音录制
            startAudio();
            ...
            public void subscribe(ObservableEmitter<String> emitter) throws Exception {
                ...
                .subscribe(new Consumer<String>() {
                    ...
                    public void accept(String s) throws Exception {
                        ...
                        Log.i(TAG, "==startVideo finish");
                    }
                }, new Consumer<Throwable>() {
                    @Override
                    public void accept(Throwable throwable) throws Exception {
                        Log.i(TAG, "==startVideo error==" + throwable.getMessage());
                    }
                });
    }
    ...
    private void startAudio() {
        Observable.create(new ObservableOnSubscribe<String>() {
            @Override
            public void subscribe(ObservableEmitter<String> emitter) throws Exception {
                audioThread.startRecordEncoder();
                emitter.onNext("");
            }
        }).subscribeOn(Schedulers.io())
                .observeOn(Schedulers.io())
                .subscribe(new Consumer<String>() {
                    @Override
                    public void accept(String s) throws Exception {
                        Log.i(TAG, "==startAudio finish");
                    }
                }, new Consumer<Throwable>() {
                    @Override
                    public void accept(Throwable throwable) throws Exception {
                        Log.i(TAG, "==startAudio error==" + throwable.getMessage());
                    }
                });
    }
